...
public class EditorWindow {
  ...
  private void jbInit() throws Exception {
    ...
    /*
	if (sm.getSetting("ACCESSIBILITY_HIGH_CONSTRAST") == null ) {
	  	// do nothing
	} else if (sm.getSetting("ACCESSIBILITY_HIGH_CONSTRAST").equals("True")) {
		highContrast();
	}
	*/
  ...
  /*Calls the highContrast method from JEditTextArea*/
  public void highContrast() {
	  jtaCodeView.highContrast();
  }
  
  /*Calls the standardContrast method from JEditTextArea*/
  public void standardContrast() {
	  jtaCodeView.standardContrast();
  }
