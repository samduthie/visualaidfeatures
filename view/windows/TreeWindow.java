    ...
    public void addSpeech() {
    	...
    	expandButton.addMouseListener(new MouseListener(){
            ...
            public void mouseEntered(java.awt.event.MouseEvent e) {
          	  sm.speak(am.getExpandTreeAction().getDescription());
            }
  	  });
    	...
    	collapseButton.addMouseListener(new MouseListener(){
          ...
          @Override
          public void mouseEntered(java.awt.event.MouseEvent e) {
        	  sm.speak(am.getCollapseTreeAction().getDescription());
          }
	  });
    	...
    	refreshButton.addMouseListener(new MouseListener(){
            ...
            @Override
            public void mouseEntered(java.awt.event.MouseEvent e) {
          	  sm.speak(am.getRefreshTreeAction().getDescription());
            }
  	  });
  	}
...
//                                  ((ParsedTest)tests.get(i)).getName(),(ParsedTest) tests.get(i))));
    ...
    public void enlargeGUI() {
    	 expandButton.setIcon(Resources.getIcon("expandTreeWindow32"));
    	 collapseButton.setIcon(Resources.getIcon("collapseTreeWindow32"));
    	 refreshButton.setIcon(Resources.getIcon("reload32"));
    	 //tree.setFont(new Font("Arial", Font.PLAIN, 12));
    }
    
    public void shrinkGUI() {
    	expandButton.setIcon(Resources.getIcon("expandTreeWindow16"));
   	 	collapseButton.setIcon(Resources.getIcon("collapseTreeWindow16"));
   	 	refreshButton.setIcon(Resources.getIcon("reload16"));
