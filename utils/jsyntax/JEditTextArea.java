          ...
          implements UndoableEditListener
{
  ...
  /*High Contrast Mode changes background to BLACK & text to CYAN and other colours*/
  public void highContrast() {
      painter.setBackground(Color.BLACK);
      painter.setForeground(Color.BLUE);
      painter.setHighlights(Color.CYAN);
      painter.setStyles(SyntaxUtilities.getHighContrastSyntaxStyles());
  }
  
  /*Standard Contrast Mode changes background to WHITE & text to BLACK*/
  public void standardContrast() {
      painter.setBackground(Color.WHITE);
      painter.setForeground(Color.BLACK);
      painter.setHighlights(TextAreaDefaults.getDefaults().lineHighlightColor);
      painter.setStyles(SyntaxUtilities.getDefaultSyntaxStyles());
  }
}
