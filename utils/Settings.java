...
public class Settings {
  ...
  // Accessibility settings to be saved in heat.settings file 
  public static final String ACCESSIBILITY_LARGE_GUI = "ACCESSIBILITY_LARGE_GUI";
  
  public static final String ACCESSIBILITY_TEXT_TO_SPEECH = "ACCESSIBILITY_TEXT_TO_SPEECH";
  
  //public static final String ACCESSIBILITY_HIGH_CONTRAST = "ACCESSIBILITY_HIGH_CONTRAST";
