...
public class SettingsManager {
  ...
  public void loadSettings() {
    ...
    System.out.println("Path to the settings file: " + SETTINGS_PATH); 
  ...
  private Properties createDefaultProperties() {
    ...
    newSettings.setProperty(Settings.ACCESSIBILITY_LARGE_GUI, "False");
    newSettings.setProperty(Settings.ACCESSIBILITY_TEXT_TO_SPEECH, "False");
    //newSettings.setProperty(Settings.ACCESSIBILITY_HIGH_CONTRAST, "False");
    return newSettings;
  }
