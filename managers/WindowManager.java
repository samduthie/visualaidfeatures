...
public class WindowManager {
  ...
  public void createGUI() {
    ...
    try {
      ...
      // make GUI larger if settings are set
      SettingsManager sm = SettingsManager.getInstance();
  	
      if (sm.getSetting("ACCESSIBILITY_LARGE_GUI").equals("True")) {
    	  enlargeGUI();
      }
 ...
 public void enlargeGUI() {
	 toolbar.enlargeGUI();
	 treeWindow.enlargeGUI();
	 jSplitTree.setDividerSize(15);
	 jSplitMain.setDividerSize(15);
	 mainScreenFrame.setMinimumSize(new Dimension(1000,600));
 }
 
 /* Shrink the GUI */
 public void shrinkGUI() {
	 toolbar.shrinkGUI(); 
	 treeWindow.shrinkGUI();
	 jSplitTree.setDividerSize(9);
	 jSplitMain.setDividerSize(9);
 }
 
 
 /* Calls the highContrast method from EditorWindowv*/
public void highContrast() {
	 displayWindow.highContrast();
}

/* Calls the standardContrast method from EditorWindowv*/
public void standardContrast() {
	 displayWindow.standardContrast();
} 
