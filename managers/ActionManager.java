...
public class ActionManager {
  ...
  private EnlargeGUIAction enlargeGUIAction = new EnlargeGUIAction("Increase size of GUI",
	      Resources.getIcon("add22"), "Increase the size of the GUI", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_J, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private ShrinkGUIAction shrinkGUIAction = new ShrinkGUIAction("Decrease size of GUI",
	      Resources.getIcon("build16"), "Shrink the GUI to the default size", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_K, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));  
  private HighContrastAction highContrastAction = new HighContrastAction("High Contrast Mode",
	      Resources.getIcon(""), "Switch to High Contrast Mode", new Integer(KeyEvent.VK_1),
	      KeyStroke.getKeyStroke(KeyEvent.VK_1, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  private StandardContrastAction standardContrastAction = new StandardContrastAction("Standard Contrast Mode",
	      Resources.getIcon(""), "Switch to Standard Contrast Mode", new Integer(KeyEvent.VK_2),
	      KeyStroke.getKeyStroke(KeyEvent.VK_2, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
		  
  
  
 // Splash screen option actions
  private SaveWizardGUIAction saveWizardGUIAction = new SaveWizardGUIAction("Continue with Enlarged Icons",
	      Resources.getIcon(""), "Continue with Enlarged Icons", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_H, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));

  private SaveWizardTTSAction saveWizardTTSAction = new SaveWizardTTSAction("Continue with Text to Speech Enabled",
	      Resources.getIcon(""), "Continue with Text to Speech Enabled", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_H, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  
  private SaveWizardGUITTSAction saveWizardGUITTSAction = new SaveWizardGUITTSAction("Continue with Enlarged Icons & Text to Speech Enabled",
	      Resources.getIcon(""), "Continue with Text to Speech Enabled", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_H, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));

  /*private SaveWizardHighCAction saveWizardHighCAction = new SaveWizardHighCAction("Continue with High Contrast Mode",
	      Resources.getIcon(""), "Continue with Text to Speech Enabled", new Integer(KeyEvent.VK_L),
	      KeyStroke.getKeyStroke(KeyEvent.VK_H, java.awt.Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false));
  */
  ...
  public ActionManager.EnlargeGUIAction getEnlargeGUIAction() {
	  return enlargeGUIAction;
  }
  
  public ActionManager.ShrinkGUIAction getShrinkGUIAction() {
	  return shrinkGUIAction;
  }
  
  public ActionManager.HighContrastAction getHighContrastAction() {
		 return highContrastAction; 
	  }
  
  public ActionManager.StandardContrastAction getStandardContrastAction() {
		 return standardContrastAction;
  }

 public ActionManager.SaveWizardGUIAction getSaveWizardGUIAction() {
	  return saveWizardGUIAction;
  }
 
 public ActionManager.SaveWizardTTSAction getSaveWizardTTSAction() {
	  return saveWizardTTSAction;
 }

 
 public ActionManager.SaveWizardGUITTSAction getSaveWizardGUITTSAction() {
	  return saveWizardGUITTSAction;
 }
 
 /*
 public ActionManager.SaveWizardHighCAction getSaveWizardHighCAction() {
	  return saveWizardHighCAction;
 }*/
...
public class SendEvaluationAction extends AbstractAction {
	private String desc;
 ...
 */
public class SaveWizardAction extends AbstractAction {
	private String desc;
...
public class RedoAction extends AbstractAction {
  ...
  public class ToggleTreeAction extends AbstractAction
  {
	  private String desc;
  ...
  public class ToggleConsoleAction extends AbstractAction
  {
	  private String desc;
   ...
   protected class GoToRecentConsoleHistory extends AbstractAction{
    ...
    public class EnlargeGUIAction extends AbstractAction {
    	private String desc;
	    public EnlargeGUIAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
    ...
    public class ShrinkGUIAction extends AbstractAction {
    	private String desc;
	    public ShrinkGUIAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
    ...
    protected class SaveWizardGUIAction extends AbstractAction {
	    public SaveWizardGUIAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
    ...
    protected class SaveWizardTTSAction extends AbstractAction {
	    public SaveWizardTTSAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
	    ...
	    public void actionPerformed(ActionEvent e) {
	      ...
	      wm.getMainMenu().addSpeech();
	      wm.getToolbar().addSpeech();
	      wm.getTreeWindow().addSpeech();
    ...
    protected class SaveWizardGUITTSAction extends AbstractAction {
	    public SaveWizardGUITTSAction(String text, ImageIcon icon, String desc,
	      Integer mnemonic, KeyStroke accelerator) {
	      super(text, icon);
	      putValue(SHORT_DESCRIPTION, desc);
	      putValue(MNEMONIC_KEY, mnemonic);
	    ...
	    protected class SaveWizardHighCAction extends AbstractAction {
		    public SaveWizardHighCAction(String text, ImageIcon icon, String desc,
		      Integer mnemonic, KeyStroke accelerator) {
		      super(text, icon);
		      putValue(SHORT_DESCRIPTION, desc);
		      putValue(MNEMONIC_KEY, mnemonic);
		    ...
		    public void actionPerformed(ActionEvent e) {
		      ...
		      //sm.setSetting(Settings.ACCESSIBILITY_HIGH_CONTRAST, "True");
		      //wm.enlargeGUI();
		      wm.getWizardWindow().close();
	  ...
	  /*  public ActionManager.StandardContrastAction getStandardContrastAction() {
		...
		public class HighContrastAction extends AbstractAction {
	    	private String desc;
		    public HighContrastAction(String text, ImageIcon icon, String desc,
		      Integer mnemonic, KeyStroke accelerator) {
		      super(text, icon);
		      putValue(SHORT_DESCRIPTION, desc);
		      putValue(MNEMONIC_KEY, mnemonic);
		    ...
		    public String getDescription() {
		     ...
		     public class StandardContrastAction extends AbstractAction {
		     	private String desc;
		 	    public StandardContrastAction(String text, ImageIcon icon, String desc,
		 	      Integer mnemonic, KeyStroke accelerator) {
		 	      super(text, icon);
		 	      putValue(SHORT_DESCRIPTION, desc);
		 	      putValue(MNEMONIC_KEY, mnemonic);
		 	    ...
		 	    public void actionPerformed(ActionEvent e) {
		 	      ...
		 	      //SettingsManager sm = SettingsManager.getInstance();
		 	      //sm.setSetting(Settings.ACCESSIBILITY_HIGH_CONTRAST, "False");
		 	      //sm.saveSettings();
		 	    }
